        ...
        JqTreeWidget = (function(_super) {
            ...
            JqTreeWidget.prototype._refreshElements = function(from_node) {
                ...
                createNodeLi = function(node) {
                    ...
                    return $("<li class=\"" + class_string + "\"><div class=\"jqtree-element jqtree_common\"><span class=\"jqtree-title jqtree_common\">" + escaped_name + "</span></div><button class=\"add_new\" data-content="+node.id+" type=\"button\">Add News</button></li>");
                };
                createFolderLi = function(node) {
                    ...
                    return $("<li class=\"jqtree_common " + folder_classes + "\"><div class=\"jqtree-element jqtree_common\"><a class=\"jqtree_common " + button_classes + "\">" + button_char + "</a><span class=\"jqtree_common jqtree-title\">" + escaped_name + "</span></div><button data-content="+node.id+" class=\"add_new\" type=\"button\">Add News</button></li>");
                };
