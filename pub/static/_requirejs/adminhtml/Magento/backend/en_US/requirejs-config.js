...
var config = {
    map: {
        '*': {
            optionsContent: 'Amasty_Shopby/js/options-content',
            chosen: 'Amasty_Shopby/js/chosen/chosen.jquery'
        }
    }
};
...
var config = {
    ...
    paths: {
        tree: 'AstralWeb_MenuManagement/js/tree.jquery',
        jqTreeContextMenu: 'AstralWeb_MenuManagement/js/jqTreeContextMenu',
    },
    shim: {
        'tree': {
            deps: ['jquery']
...
var config = {
    paths: {
        'report/template': 'Mirasvit_Report/templates'
    },
    map: {
        '*': {
