...
namespace Astralweb\Checkout\Block\Checkout;
...
class LayoutProcessor extends \Magento\Checkout\Block\Checkout\LayoutProcessor {
    ...
    public function process($jsLayout)
    {
        ...
        if (isset($jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ...
            ['shippingAddress']['children'] = $this->processPaymentChildrenComponents(
                $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
                ['shippingAddress']['children'],
                $elements
            );
        ...
        if (isset($jsLayout['components']['checkout']['children']['sidebar']['children']['shipping-information']['children'])) {
            $jsLayout['components']['checkout']['children']['sidebar']['children']['shipping-information']['children']
             = $this->processPaymentChildrenComponentsBilling(
                $jsLayout['components']['checkout']['children']['sidebar']['children']['shipping-information']['children'],
                $elements
            );
        }
    ...
    private function processPaymentChildrenComponentsBilling(
        array $paymentLayout,
        array $elements
    ) {
            ...
            $paymentLayout['ship-to']['children'] = array_merge_recursive(
                $component,
                $paymentLayout['ship-to']['children']
            );
    ...
    private function processPaymentChildrenComponents(
        ...
        if ($this->getCheckoutDataHelper()->isDisplayBillingOnPaymentMethodAvailable()) {
            ...
            $paymentLayout['address-list-additional-addresses']['children'] = array_merge_recursive(
                $component,
                $paymentLayout['address-list-additional-addresses']['children']
            );
        }
