...
namespace Astralweb\Shippingcvs\Model\Carrier;
...
class Collect extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    ...
    protected $_code = 'collect_storecvs';
    ...
    public function __construct(
        ...
        \Astralweb\Shippingcvs\Model\Carrier\Shippingcvs\ItemPriceCalculator $itemPriceCalculator,
        array $data = []
    ) {
    ...
    {
        return ['collect_storecvs' => $this->getConfigData('name')];
    }
...
//
//        $method->setCarrier('collect_storecvs');
//        $method->setCarrierTitle($this->getConfigData('title'));
//
//        $method->setMethod('collect_storecvs');
