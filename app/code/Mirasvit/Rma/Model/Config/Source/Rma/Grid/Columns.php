...
class Columns implements \Magento\Framework\Option\ArrayInterface
{
    ...
    public function toArray()
    {
        $options = [
            ...
            Config::RMA_GRID_COLUMNS_CUSTOMER_PHONE     => __('Customer Phone'),
            Config::RMA_GRID_COLUMNS_CUSTOMER_ADDRESS   => __('Customer Address'),
            ...
            Config::RMA_GRID_COLUMNS_SKU                => __('Refunded Products SKU'),
