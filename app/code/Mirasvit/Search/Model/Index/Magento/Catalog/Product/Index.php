...
class Index extends AbstractIndex
{
    ...
    protected function buildSearchCollection()
    {
        ...
        if ($this->getModel()->hasProperty('out_of_stock_to_end')) {
            $collection->getSelect()->order(new \Zend_Db_Expr('stock_status_index.stock_status DESC'));
        }
        ...
        //        $session = $this->objectManager->get('Magento\Catalog\Model\Session');
        //
        //        if ($session->getData('sort_order') == '' && $session->getData('sort_direction') == '') {
